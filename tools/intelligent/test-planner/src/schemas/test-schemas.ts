...
const scenarioCandidateSchema = {
  ...
  required: [
    'temporaryId', 'title', 'objective', 'category', 'requirementIds',
    'preconditions', 'dataNeeds', 'expectedBehavior', 'priority',
...
const testCaseCandidateSchema = {
  ...
  required: [
    'temporaryId', 'scenarioTemporaryId', 'requirementIds', 'title',
    'objective', 'type', 'priority', 'preconditions', 'inputs', 'steps',
    'expectedResults', 'cleanup', 'automation', 'provenance', 'confidence',
  ],
  additionalProperties: false,
} as const;
