  ...
  return (
    <div className="space-y-10">
      ...
      <div className="text-center py-8">
        ...
        <h1 data-testid="dashboard-heading" className="text-2xl sm:text-4xl font-bold mb-3 tracking-tight">TanStack Full Demo</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {features.map(f => (
          <Link key={f.href} to={f.href} data-testid={`feature-${f.tab}`} onClick={() => setTab(f.tab)}
